...
const FEATURES = [
  ...
  { icon: "🎧", title: "Audio-Based MCQs", desc: "Listen to realistic driving scenarios and choose the safest course of action.", color: "#1a1f71", bg: "#eef0fa", border: "#c7cce6" },
  { icon: "🖼️", title: "Image Psychometrics", desc: "Analyze visual scenes to evaluate your psychological response and empathy.", color: "#1a1f71", bg: "#eef0fa", border: "#c7cce6" },
  { icon: "🎬", title: "Video Scenarios", desc: "Watch animated clips of dangerous driving behavior and identify the proper response.", color: "#1a1f71", bg: "#eef0fa", border: "#c7cce6" },
];
...
const STEPS = [
  { num: "01", title: "Enter Your Name", desc: "Provide your name to personalize the assessment and your result card.", color: "#1a1f71", icon: "👤" },
  { num: "02", title: "Answer 20 MCQs", desc: "Navigate through text, audio, image, and video questions within the 12-minute timer.", color: "#1a1f71", icon: "✍️" },
  { num: "03", title: "Get Instant Results", desc: "Receive a detailed scorecard with risk level, category breakdown, and 12-hour driving eligibility.", color: "#27ae60", icon: "📊" },
];
    ...
    <div style={{ minHeight: "100vh", background: "#f7f8fc" }}>
      ...
      <nav className="anim-in" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: "1.2rem", fontWeight: 800, color: "#1a1f71" }}>
            DriveIQ
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 40, marginBottom: 40 }}>
          <div style={{ flex: "1 1 400px", textAlign: "left" }}>
            <h1 className="anim-up d1" style={{
              ...
              lineHeight: 1.1, marginBottom: 16, letterSpacing: "-1.5px", color: "#1a1f71",
            }}>
            ...
            <h2 className="anim-up d2" style={{
              ...
              <span style={{ color: "#1a1f71", transition: "all 0.3s ease" }}>{words[wordIdx]}</span> Driver Assessment System
            </h2>
        ...
        <div className="card anim-up d5" style={{
          ...
          {STATS.map((s, i) => (
            <div key={i} style={{
              ...
              <div style={{ fontSize: "1.2rem", fontWeight: 800, color: "#1a1f71" }}>{s.value}</div>
      ...
      <section style={{ padding: "60px 24px", maxWidth: 1000, margin: "0 auto" }}>
        <h3 className="anim-up" style={{ textAlign: "center", fontSize: "clamp(1.4rem, 3vw, 2rem)", fontWeight: 800, marginBottom: 8, color: "#1a1f71" }}>
          Four Assessment Dimensions
        </h3>
        <p style={{ textAlign: "center", color: "#64748b", fontSize: "0.95rem", marginBottom: 40, maxWidth: 460, margin: "0 auto 40px" }}>
          ...
          {FEATURES.map((f, i) => (
            <div
              ...
              style={{
                ...
                cursor: "default",
                borderColor: hovered === i ? "#1a1f71" : "#e8ecf2",
                boxShadow: hovered === i
                  ? "0 8px 30px rgba(26,31,113,0.1)"
            ...
            >
              ...
              <h4 style={{ fontSize: "1.1rem", fontWeight: 700, color: "#1a1f71", marginBottom: 10 }}>{f.title}</h4>
      ...
      <section id="how" style={{ padding: "40px 24px 60px", maxWidth: 720, margin: "0 auto" }}>
        <h3 style={{ textAlign: "center", fontSize: "clamp(1.3rem, 3vw, 1.8rem)", fontWeight: 800, marginBottom: 40, color: "#1a1f71" }}>
          How It Works
        </h3>
          ...
          {STEPS.map((s, i) => (
            <div key={i} className="card anim-up" style={{
              ...
              <div style={{
                ...
                background: "#eef0fa", border: "1.5px solid #c7cce6",
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: 24,
              }}>{s.icon}</div>
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
                  <span style={{ fontSize: "0.72rem", fontWeight: 800, color: "#1a1f71", fontFamily: "monospace" }}>{s.num}</span>
                  <h4 style={{ fontSize: "1rem", fontWeight: 700, color: "#1a1f71" }}>{s.title}</h4>
                </div>
      ...
      <section style={{ padding: "20px 24px 60px", textAlign: "center" }}>
        <div className="card anim-up" style={{
          ...
          <h3 style={{ fontSize: "1.5rem", fontWeight: 800, marginBottom: 10, color: "#1a1f71" }}>Ready to Get Assessed?</h3>
        ...
        <p style={{ marginTop: 32, fontSize: "0.75rem", color: "#94a3b8" }}>
          DriveIQ v1.0 • Professional Driver Assessment Platform
        </p>
      </section>
    </div>
  );
